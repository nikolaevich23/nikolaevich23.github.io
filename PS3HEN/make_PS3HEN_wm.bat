...
mv *CEX_480 *CEX_481 *CEX_482 *CEX_483 *CEX_484 *CEX_485 *CEX_486 *CEX_487 *CEX_488 *CEX_489 *CEX_490 *CEX_491 *CEX_492 *CEX_492 PS3HEN_GEN
cd henplugin
...
rm -f *.o *.elf *.self ../lv1/src/*.o ../debug/src/*.o ../lv2/src/*.o
cd ..
mv *480C *481C *482C *483C *484C *485C *486C *487C *488C *489C *490C *491C *492C *493C PS3HEN_GEN
cd PS3HEN_GEN
...
HEN_GEN PS3HEN.BIN_CEX_493 stage2.bin_493C stage0.bin_493C HENplugin.sprx
rm stage* *.sprx *.exe
mv PS3HEN* ../
