...
static void copyflag_thread(void)
{
	...
	filecopy("/dev_hdd0/hen/off.off","/dev_hdd0/hen/hen_old.on", "/dev_hdd0/hen/hen_old.off");
	filecopy("/dev_hdd0/hen/on.png","/dev_hdd0/hen/hen_old.png", "/dev_hdd0/hen/hen_old.off");
