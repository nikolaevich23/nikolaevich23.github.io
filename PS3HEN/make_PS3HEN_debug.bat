...
mv *DEX_482_DEBUG *DEX_484_DEBUG *CEX_480_DEBUG *CEX_481_DEBUG *CEX_482_DEBUG *CEX_483_DEBUG *CEX_484_DEBUG *CEX_485_DEBUG *CEX_486_DEBUG *CEX_487_DEBUG *CEX_488_DEBUG *CEX_489_DEBUG *CEX_490_DEBUG *CEX_491_DEBUG *CEX_492_DEBUG *CEX_493_DEBUG PS3HEN_GEN
cd henplugin
...
rm -f *.o *.elf *.self ../lv1/src/*.o ../debug/src/*.o ../lv2/src/*.o
cd ..
mv *482D *484D *480C *481C *482C *483C *484C *485C *486C *487C *488C *489C *490C *491C *492C *493C PS3HEN_GEN
cd PS3HEN_GEN
...
rem HEN_GEN PS3HEN.BIN_DEX_482_DEBUG stage2.bin_debug_482D stage0.bin_482D HENplugin.sprx
...
rem HEN_GEN PS3HEN.BIN_DEX_484_DEBUG stage2.bin_debug_484D stage0.bin_484D HENplugin.sprx
...
HEN_GEN PS3HEN.BIN_CEX_493_DEBUG stage2.bin_debug_492C stage0.bin_493C HENplugin.sprx
rm stage* *.sprx *.exe
mv PS3HEN* ../
pause