...
## Изменения в 3.5.0
- Поддержка 4.93.2 HFW
- Добавлена ссылка для скачивания 4.93.2 HFW в разделе обновление

## Изменения в 3.4.3
- Включена поддержка горячих клавиш (снова)
- Добавлен условный таймер для Retail и NPDRM self, чтобы уменьшить зависания при запуске самодельных приложений
- Поддержка декодирования PS3ISO на лету
...
- Добавлена возможность скачать 4.92.2 HFW в разделе обновление
